  ...
  return (
    <section id="contact" className="bg-black py-24 md:py-32 px-4 md:px-6 relative">
      <div className="max-w-4xl mx-auto text-center space-y-12">
        ...
        <div className="max-w-2xl mx-auto bg-[#101010] rounded-2xl border border-white/10 p-8 sm:p-10 shadow-2xl">
        ...
        <p className="text-xs text-gray-600 font-mono pt-12">
          © {new Date().getFullYear()} Rakshit Raj. Built with Prisma design aesthetics.
        </p>
      </div>
    </section>
  );
