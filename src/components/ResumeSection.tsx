      ...
      <div className="max-w-6xl mx-auto bg-[#101010] rounded-2xl md:rounded-[2.5rem] p-8 sm:p-12 md:p-14 border border-white/5 shadow-2xl flex flex-col md:flex-row items-center justify-between gap-8">
        ...
        <div className="shrink-0 w-full md:w-auto">
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="w-full md:w-auto bg-primary text-black hover:bg-primary/90 font-medium text-sm uppercase py-4 px-8 rounded-full flex items-center justify-center gap-3 transition-all duration-300 shadow-lg"
          >
